...
// import 'package:myapp/data/database_atual.dart'; // imports para as opções de manipulação e consulta do banco de dados
              ...
              ListTile( 
                ...
                onTap: () {
                  ...
                  Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const BancoDeDados(), // atualmente apenas para motivos de exibição de rota, foi deixado como destino a página de banco de dados.
                          ),
                        );
                },
              ),
